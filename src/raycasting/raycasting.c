...
//										  &data->img[0].bits_per_pixel,
//										  &data->img[0].line_length, &data->img[0].endian);
//	data->img[1].img = data->tex.no;
//	data->img[1].addr = mlx_get_data_addr(data->img[1].img,
//										  &data->img[1].bits_per_pixel,
//										  &data->img[1].line_length, &data->img[1].endian);
//	data->img[2].img = data->tex.ea;
//	data->img[2].addr = mlx_get_data_addr(data->img[2].img,
//										  &data->img[2].bits_per_pixel,
//										  &data->img[2].line_length, &data->img[1].endian);
//	data->img[3].img = data->tex.we;
//	data->img[3].addr = mlx_get_data_addr(data->img[3].img,
//										  &data->img[3].bits_per_pixel,
//										  &data->img[3].line_length, &data->img[1].endian);
//}
...
//	img_pos = (draw_start - data->game.win_h / 2 + line_height / 2) * step;
